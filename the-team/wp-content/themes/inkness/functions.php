...
/**
* Custom Functions - Kaushtuvgurung@gmail.com
* Code Igniter Base Url to get url from the main website: kaushtuvgurung@gmail.com
*/
function base_url(){
	return str_replace('the-team','',home_url());	
}
