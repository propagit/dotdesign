<div id="banners" class="carousel slide featured-work-carousel" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="<?=base_url();?>assets/img/work/gallery/map/map1.jpg">
                    <span class="title hidden-xs hidden-sm">Map Coffee</span>
                ...
                <div class="item">
                    <img src="<?=base_url();?>assets/img/work/gallery/map/map2.jpg">
                    <span class="title hidden-xs">Map Coffee</span>
                    <div class="description hidden-xs hidden-sm">
                        <button type="button" class="btn btn-app btn-angle hide-desc"><i class="fa fa-angle-down"></i></button>
                        <h1>Map Coffee</h1>
                        <p>
                ...
                <div class="item">
                    <img src="<?=base_url();?>assets/img/work/gallery/map/map3.jpg">
                    <span class="title hidden-xs">Map Coffee</span>
                    <div class="description hidden-xs hidden-sm">
                        <button type="button" class="btn btn-app btn-angle hide-desc"><i class="fa fa-angle-down"></i></button>
                        <h1>Map Coffee</h1>
