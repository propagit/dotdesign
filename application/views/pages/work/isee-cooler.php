<div id="banners" class="carousel slide featured-work-carousel" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <span class="title hidden-xs hidden-sm">iSee Cooler </br> (patent pending)</span>
                    <div class="description hidden-xs hidden-sm">
                        <button type="button" class="btn btn-app btn-angle hide-desc"><i class="fa fa-angle-down"></i></button>
                        <h1>iSee Cooler: (patent pending)</h1>
                        <p>
                ...
                <div class="item">
                    ...
                    <span class="title hidden-xs">iSee Cooler </br> (patent pending)</span>
                    <div class="description hidden-xs hidden-sm">
                        <button type="button" class="btn btn-app btn-angle hide-desc"><i class="fa fa-angle-down"></i></button>
                        <h1>iSee Cooler: (patent pending) </h1>
                        <p>
